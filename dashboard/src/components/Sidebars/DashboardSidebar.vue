<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Smallville</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/dashboard">
						...
						<span class="label">World Information</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/tables">
						...
						<span class="label">Agents & Locations</span>
					</router-link>
				</a-menu-item>
			</a-menu>
			<!-- / Sidebar Navigation Menu -->
			...
			<div class="aside-footer">
				<div class="footer-box">
					...
					<a-button type="primary" href="https://nickm980.github.io/smallville/" block target="_blank">
						DOCUMENTATION
					</a-button>
				</div>
			</div>
